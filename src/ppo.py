...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="LunarLander-v2-PPO-cleanRL",
    ...
    parser.add_argument("--repo-id", type=str, default="Nelsonlin0321/ppo-CartPole-v2", help="id of the model repository from the Hugging Face Hub {username/repo_name}")
